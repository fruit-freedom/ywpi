...
YWPI_GRPC_KEEPALIVE_TIME_MS = int(os.getenv('YWPI_GRPC_KEEPALIVE_TIME_MS', 7200000)) # As server default 2h
# TODO: Think about default timeout value. 2h is too long for active streaming tasks
