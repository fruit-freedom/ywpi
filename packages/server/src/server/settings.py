...
MONGO_CONNECTION_STRING = os.getenv('MONGO_CONNECTION_STRING', 'mongodb://mongo:mongo@localhost:27017/')
HUB_CONNECTION_STRING   = os.getenv('HUB_CONNECTION_STRING', 'localhost:50051')
