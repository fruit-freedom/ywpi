...
from ywpi import hub_pb2 as ywpi_dot_hub__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in ywpi/hub_pb2_grpc.py depends on'
...
class HubStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Connect = channel.stream_stream(
                '/Hub/Connect',
                request_serializer=ywpi_dot_hub__pb2.Message.SerializeToString,
                response_deserializer=ywpi_dot_hub__pb2.Message.FromString,
...
def add_HubServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Connect': grpc.stream_stream_rpc_method_handler(
                    servicer.Connect,
                    request_deserializer=ywpi_dot_hub__pb2.Message.FromString,
                    response_serializer=ywpi_dot_hub__pb2.Message.SerializeToString,
            ),
...
class Hub(object):
    ...
    def Connect(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/Hub/Connect',
            ywpi_dot_hub__pb2.Message.SerializeToString,
            ywpi_dot_hub__pb2.Message.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
